...
public class ValidationServlet extends HttpServlet {
  ...
  private static final List<String> CONSUMES =
      Arrays.asList(MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, "application/ld+json");
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    final String epcisVersion =
        Optional.ofNullable(req.getHeader("GS1-EPCIS-Version")).orElse("2.0.0");
