...
public class SchemaValidator {
   ...
   * @param epcisDocumentSchema type of EPCIS Document schema against which the document needs to be
   *     validated against: Capture or Query schema.
   */
  public Multi<ValidationError> validate(
    ...
    throw new UnsupportedOperationException("Unsupported schema type : " + epcisDocumentSchema);
  }
